...
function randomRectangle(n){
    ...
    for(i=0;i<n;i++){
        arrayOfRectangles.push(new Rectangle( Math.trunc((Math.random()*100)+1), Math.trunc((Math.random()*100)+1), Math.trunc((Math.random()*10)+1), Math.trunc((Math.random()*100)+1) ));
